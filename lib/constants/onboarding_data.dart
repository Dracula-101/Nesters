...
List<OnboardingContent> contents = [
  ...
  OnboardingContent(
    image: AppVectorImages.onboardingPreviewImage,
    title: 'Connect with Your College Community',
    description:
        'Explore a vibrant community of students from your college. Whether you\'re looking to share a room or find a roommate, We connects you with like-minded individuals seeking accommodation solutions just like you.',
  ),
  OnboardingContent(
    image: AppVectorImages.onboardingPreviewImage,
